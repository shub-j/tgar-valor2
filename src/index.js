...
let shardingManager = new Discord.ShardingManager(path.join(__dirname, 'Shard.js'), {
  token: "NzA3MDg0NzAxMjE4NjM1ODc3.XrDp8Q.syuUtOmDKZIuKnSVhX5VjXwtrlw",
...
async function getNextActivity () {
  ...
  switch (currentActivity) {
    case 0:
      return { text: 'https://www.roblox.com/groups/5928992/TGAR-The-Jedi-Order-TGAR#!/about' }
    case 1:
      ...
      return { text: 'The Grand Army of The Republic', type: 'WATCHING' }
    case 2:
      return { text: 'to everyone talk', type: 'LISTENING' }
    case 3:
